...
public class Pro01 {
    ...
    public static void main(String[] args) {
        ...
        switch(game) {
            case "묵":
            case "바위":
                if (com_value.equals("묵") || com_value.equals("바위")){
                    System.out.printf("컴퓨터가 낸 것은 %s 입니다.\n", com_value);
                    System.out.println("비겼습니다.");
                    break;
                }else if(com_value.equals("찌") || com_value.equals("가위")) {
                    System.out.printf("컴퓨터가 낸 것은 %s 입니다.\n", com_value);
                    System.out.println("이겼습니다.");
                    break;
                }else if(com_value.equals("빠") || com_value.equals("보")) {
                    System.out.printf("컴퓨터가 낸 것은 %s 입니다.\n", com_value);
                    System.out.println("졌습니다.");
                    break;
                }
                break;
			/* 사용자가 입력한 값이 묵 or 바위일 때의 case를 설정한 것이고 이 값과 컴퓨터가 랜덤으로 추출될 값을 비교하여
            ...
            case "가위":
                ...
                break;
			/* 사용자가 입력한 값이 찌 or 가위일 때의 case를 설정한 것이고 이 값과 컴퓨터가 랜덤으로 추출될 값을 비교하여
			패배 승리 비김 등을 비교하여 출력함 */
            ...
            case "보":
                ...
                break;
			/* 사용자가 입력한 값이 빠 or 보일 때의 case를 설정한 것이고 이 값과 컴퓨터가 랜덤으로 추출될 값을 비교하여
			패배 승리 비김 등을 비교하여 출력함 */
